...
export function TopBar() {
  ...
  return (
    ...
    >
      ...
      {/* Right controls — desktop keeps bell + theme toggle; mobile gets a hamburger instead */}
      <div className="flex items-center gap-2">
        {/* Desktop only (md+): bell + theme toggle, unchanged */}
        ...
        {/* Mobile only (below md): hamburger — opens the NavDrawer */}
        <motion.button
