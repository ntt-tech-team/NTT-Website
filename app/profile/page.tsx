...
export default function ProfilePage() {
  ...
  const membershipStatus: MembershipStatus = profile?.membership_status ?? 'not_applied'
  ...
  return (
    <div className="px-4 py-5 max-w-lg mx-auto">
      ...
      >
        <Link
          href={membershipStatus === 'approved' ? '#' : '/join'}
          onClick={e => { if (membershipStatus === 'approved') e.preventDefault() }}
      ...
      >
        {[
          { href: '/events', icon: '📋', label: 'My Registrations', sub: 'View all your event sign-ups', locked: !user },
          { icon: '🔔', label: 'Notification Preferences', sub: 'Web Push, Email, Telegram', locked: true },
          { icon: '🎟️', label: 'Event History', sub: 'Past events you attended', locked: true },
